...
<template>
    <section class="h-screen bg-cover bg-no-repeat bg-center relative" style="background-image: url('src/assets/img/mainsite-waiter.jpg');">
        <div class="w-full h-full absolute top-0 left-0 bg-black opacity-60"></div>
        <div id="content" class="container mx-auto h-3/5 flex items-end">
    ...
    <section class="h-screen bg-cover bg-no-repeat bg-center relative" style="background-image: url('src/assets/img/mainSite-food.jpg');">
        <div class="w-full h-full absolute top-0 left-0 bg-black opacity-60"></div>
        <div id="content" class="container mx-auto h-3/5 flex items-end">
            <div class="w-1/3 z-10">
    ...
    <section class="h-screen bg-cover bg-no-repeat bg-center relative" style="background-image: url('src/assets/img/mainSite-interior01.jpg');">
        <div class="w-full h-full absolute top-0 left-0 bg-black opacity-60"></div>
        <div id="content" class="container mx-auto h-3/5 flex items-end">
            <div class="w-1/3 z-10">
